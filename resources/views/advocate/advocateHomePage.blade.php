...
<nav class="navbar navbar-height">
  ...
  <ul class="navbar-nav">
		<li class="user-content" >
			<a href="{{ route('announcements') }}"  target="client-content">
    		<div class="mx-auto" style="width: 80px;height: 80px;">
        	<img src="images/icon4.png" class="img-fluid" >
				</div>
  			<h5 class="user" style="text-align:center;padding-top:20px;">Hello Advocate!</h5>
			</a>
  	</li>
		<hr class="my-hr">
		<li class="nav-item ">
      <a class="nav-link mynavbar-item" href="advocateProfile" target="client-content">Profile</a>
    </li><hr class="my-hr">
    <li class="nav-item">
      <a class="nav-link mynavbar-item" href="advocateCurrentCases" target="client-content">View Current Cases</a>
    </li><hr class="my-hr">
    <li class="nav-item">
      <a class="nav-link mynavbar-item" href="caseRequest" target="client-content">View Case Request</a>
    </li><hr class="my-hr">
    <li class="nav-item">
